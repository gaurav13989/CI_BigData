<div id = "uploadBox" style="float: left; max-width: 45%;">
	Upload file<br/><br/>
	<?php 
	if(!empty($error))
	...
	<i style="font-size: 15px">If after uploading, the file doesn't appear in the list of files below, there was an error while either uploading or loading the file data into the database. Please check the data structuring in the file<br/>
...
<div id="deleteBox" style="float: left; max-width: 45%;">
	Delete File
	<ul>
	...
	<div class="record">
		...
		<div class="cell"><input type="button" value="DELETE" class="deleteBtn" <?php if($file->fileName == 'features.txt' && $size > 1) { echo 'disabled=\'disabled\''; }?>/></div><?// delete button?>
		<div class="clear"></div>
	</div>
	<?php } // for loop end?>
</div>
